...
print('\n**********************************************************************')
print('*                            QDeep                                   *')
print('*        Protein sinlge-model quality assessment using ResNet        *')
...
parser.add_argument('--fas', dest='fasta_file',
        default = '',    # default empty!
        help = 'Fasta file')

parser.add_argument('--dec', dest='decoy_dir',
        default = '',    # default empty!
...
parser.add_argument('--spd', dest='spd33_file',
        default = '',    # default empty!
...
#---------------------------------------------------------------#
if(deep_msa == 'no'):
        model_1_0 = qDeep_path + '/models/shallow_aln/1.0/model_on_parameter_1'
        model_2_0 = qDeep_path + '/models/shallow_aln/2.0/model_on_parameter_1'
        model_4_0 = qDeep_path + '/models/shallow_aln/4.0/model_on_parameter_1'
        model_8_0 = qDeep_path + '/models/shallow_aln/8.0/model_on_parameter_1'

        model_1_0_weight = qDeep_path + '/models/shallow_aln/1.0/weights_on_parameter_1.h5'
        model_2_0_weight = qDeep_path + '/models/shallow_aln/2.0/weights_on_parameter_1.h5'
        model_4_0_weight = qDeep_path + '/models/shallow_aln/4.0/weights_on_parameter_1.h5'
        model_8_0_weight = qDeep_path + '/models/shallow_aln/8.0/weights_on_parameter_1.h5'

if(deep_msa == 'yes'):
	model_1_0 = qDeep_path + '/models/deep_aln/1.0/model_on_parameter_1'
	model_2_0 = qDeep_path + '/models/deep_aln/2.0/model_on_parameter_1'
	model_4_0 = qDeep_path + '/models/deep_aln/4.0/model_on_parameter_1'
	model_8_0 = qDeep_path + '/models/deep_aln/8.0/model_on_parameter_1'

	model_1_0_weight = qDeep_path + '/models/deep_aln/1.0/weights_on_parameter_1.h5'
	model_2_0_weight = qDeep_path + '/models/deep_aln/2.0/weights_on_parameter_1.h5'
...
class QDeep():
        ...
        def sort_scores(self):
                ...
                with open(output_path + "/" + target_name + ".score") as sFile:
                    ...
                    for line in sFile:
                            tmp = line.split()
                            if(len(tmp) > 0 and c > 0):
                                    lines.append(line)
                            c += 1

                score_file = open(output_path + "/" + target_name + ".score", 'w')
                score_file.write("Decoy        GDT-TS\n")
...
def main():
        ...
        if(q.check_options() == True):
                ...
                print('See QDeep out: ' + output_path + '/' + target_name + '.score\n')
